...
weights = {
    ...
    '4_wc1ab': tf.Variable(tf.random_normal([num, num, 16, 16])),
    '4_wc1ac': tf.Variable(tf.random_normal([num, num, 16, 16])),
    '4_wc1ba': tf.Variable(tf.random_normal([1, 1, num2*4, 16])),
    '4_wc1bb': tf.Variable(tf.random_normal([num, num, 16, 16])),
    ...
    '5_wc1ab': tf.Variable(tf.random_normal([num, num, 8, 8])),
    '5_wc1ac': tf.Variable(tf.random_normal([num, num, 8, 8])),
    '5_wc1ba': tf.Variable(tf.random_normal([1, 1, 64, 8])),
    '5_wc1bb': tf.Variable(tf.random_normal([num, num, 8, 8])),
    ...
    '6_wc1ab': tf.Variable(tf.random_normal([num, num, 4, 4])),
    '6_wc1ac': tf.Variable(tf.random_normal([num, num, 4, 4])),
    '6_wc1ba': tf.Variable(tf.random_normal([1, 1, 32, 4])),
    '6_wc1bb': tf.Variable(tf.random_normal([num, num, 4, 4])),
    ...
    '7_wc1ab': tf.Variable(tf.random_normal([num, num, 4, 4])),
    '7_wc1ac': tf.Variable(tf.random_normal([num, num, 4, 4])),
    '7_wc1ba': tf.Variable(tf.random_normal([1, 1, 16, 4])),
    '7_wc1bb': tf.Variable(tf.random_normal([num, num, 4, 4])),
