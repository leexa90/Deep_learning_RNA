...
weights = {
    ...
    '3_wc1bb': tf.Variable(tf.random_normal([window/4, window/4, num3, num3])),
...
##    '4_wc1d': tf.Variable(tf.random_normal([1, 1, num3*4, 16])),
    ...
    '4_wc1bb': tf.Variable(tf.random_normal([window/4, window/4, num4, num4])),
    ...
    '5_wc1bb': tf.Variable(tf.random_normal([window/4, window/4, num5, num5])),
    ...
    '6_wc1bb': tf.Variable(tf.random_normal([window/4, window/4, num6, num6])),
    ...
    '7_wc1bb': tf.Variable(tf.random_normal([window/4, window/4, num7, num7])),
