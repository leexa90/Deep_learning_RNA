...
weights = {
    ...
    '1_wc1bb': tf.Variable(tf.random_normal([window, 1, num1, num1])),
...
##    '5_wc1ab': tf.Variable(tf.random_normal([window, window, 8, 8])),
##    '5_wc1ac': tf.Variable(tf.random_normal([window, window, 8, 8])),
##    '5_wc1ba': tf.Variable(tf.random_normal([1, 1, 64, 8])),
##    '5_wc1bb': tf.Variable(tf.random_normal([window, window, 8, 8])),
...
##    '6_wc1ab': tf.Variable(tf.random_normal([window, window, 4, 4])),
##    '6_wc1ac': tf.Variable(tf.random_normal([window, window, 4, 4])),
##    '6_wc1ba': tf.Variable(tf.random_normal([1, 1, 32, 4])),
##    '6_wc1bb': tf.Variable(tf.random_normal([window, window, 4, 4])),
...
##    '7_wc1ab': tf.Variable(tf.random_normal([window, window, 4, 4])),
##    '7_wc1ac': tf.Variable(tf.random_normal([window, window, 4, 4])),
##    '7_wc1ba': tf.Variable(tf.random_normal([1, 1, 16, 4])),
##    '7_wc1bb': tf.Variable(tf.random_normal([window, window, 4, 4])),
...
conv1cb = tf.layers.average_pooling2d(conv1ca,(1,2),1,padding='same')
...
conv2ca = tf.layers.average_pooling2d(conv1,(1,2),1,padding='same')
