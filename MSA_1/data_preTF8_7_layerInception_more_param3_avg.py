...
weights = {
    ...
    '1_wc1ab': tf.Variable(tf.random_normal([1, 3*window, num1, num1])),
    '1_wc1ac': tf.Variable(tf.random_normal([1, 3*window, num1, num1])),
    '1_wc1ba': tf.Variable(tf.random_normal([15, 1, 1, num1])),
    '1_wc1bb': tf.Variable(tf.random_normal([1, 3*window, num1, num1])),
    ...
    '3_wc1ab': tf.Variable(tf.random_normal([window, window, num3, num3])),
    '3_wc1ac': tf.Variable(tf.random_normal([window, window, num3, num3])),
    '3_wc1ba': tf.Variable(tf.random_normal([1, 1, num2*4+1, num3])),
    '3_wc1bb': tf.Variable(tf.random_normal([window, window, num3, num3])),
...
##    '4_wc1d': tf.Variable(tf.random_normal([1, 1, num3*4, 16])),
    ...
    '4_wc1ab': tf.Variable(tf.random_normal([window, window, num4, num4])),
    '4_wc1ac': tf.Variable(tf.random_normal([window, window, num4, num4])),
    '4_wc1ba': tf.Variable(tf.random_normal([1, 1, num3*4, num4])),
    '4_wc1bb': tf.Variable(tf.random_normal([window, window, num4, num4])),
    ...
    '5_wc1ab': tf.Variable(tf.random_normal([window, window, num5, num5])),
    '5_wc1ac': tf.Variable(tf.random_normal([window, window, num5, num5])),
    '5_wc1ba': tf.Variable(tf.random_normal([1, 1, num4*4, num5])),
    '5_wc1bb': tf.Variable(tf.random_normal([window, window, num5, num5])),
    ...
    '6_wc1ab': tf.Variable(tf.random_normal([window, window, num6, num6])),
    '6_wc1ac': tf.Variable(tf.random_normal([window, window, num6, num6])),
    '6_wc1ba': tf.Variable(tf.random_normal([1, 1, num5*4, num6])),
    '6_wc1bb': tf.Variable(tf.random_normal([window, window, num6, num6])),
    ...
    '7_wc1ab': tf.Variable(tf.random_normal([window, window, num7, num7])),
    '7_wc1ac': tf.Variable(tf.random_normal([window, window, num7, num7])),
    '7_wc1ba': tf.Variable(tf.random_normal([1, 1, num6*4, num7])),
    '7_wc1bb': tf.Variable(tf.random_normal([window, window, num7, num7])),
