...
weights = {
    ...
    '3_wc1aa': tf.Variable(tf.random_normal([1, 1, 65, 32])),
    '3_wc1ab': tf.Variable(tf.random_normal([num, 1, 24, 24])),
    '3_wc1ac': tf.Variable(tf.random_normal([num, 1, 24, 24])),
    '3_wc1ba': tf.Variable(tf.random_normal([1, 1, 65, 24])),
    '3_wc1bb': tf.Variable(tf.random_normal([num, 1, 24, 24])),
    '3_wc1c': tf.Variable(tf.random_normal([1, 1, 65, 24])),
    '3_wc1d': tf.Variable(tf.random_normal([1, 1, 65, 24])),
    
    '3_wc3a': tf.Variable(tf.random_normal([1, 10, 65, 32])),
    '4_wc3b': tf.Variable(tf.random_normal([10, 1, 65, 32])),    
...
biases = {
    ...
    '3_bc1aa': tf.Variable(tf.random_normal([24])),
    '3_bc1ab': tf.Variable(tf.random_normal([24])),
    '3_bc1ac': tf.Variable(tf.random_normal([24])),
    '3_bc1ba': tf.Variable(tf.random_normal([24])),
    '3_bc1bb': tf.Variable(tf.random_normal([24])),
    '3_bc1c': tf.Variable(tf.random_normal([24])),
    '3_bc1d': tf.Variable(tf.random_normal([24])),
...
conv1d = conv2d(norm_x,weights['1_wc1d'],biases['1_bc1d'])
conv1 = tf.concat([conv1ac,conv1bb,conv1cb,conv1d],3)
...
conv2d = conv2d(conv1,weights['2_wc1d'],biases['2_bc1d'])

conv2 = tf.concat([conv2ac,conv2bb,conv2cb,conv2d],3)
final = []
for i in range(0,64):
    mat_x = conv2[:,:,:,i]
